...
```{r fig-9-2, echo=FALSE, fig.margin=FALSE, fig.cap='Corporation Tax and Income Tax*. Source: Author'}
knitr::include_graphics('ChapterPictures/9-2-IncTaxandCorpTax.png', dpi = NA)
```
...
```{r fig-9-3, echo=FALSE, fig.margin=FALSE, fig.cap='Corporation Tax Rates Around the World. Source: Miller (2013)'}
knitr::include_graphics('ChapterPictures/9-3-EUCorpTaxRates.png', dpi = NA)
```
...
```{r fig-9-4, echo=FALSE, fig.margin=FALSE, fig.cap='UK Corporation Tax Rate Cuts. Source: Miller (2017)'}
knitr::include_graphics('ChapterPictures/9-4-UKCorpTaxCuts.png', dpi = NA)
```
...
```{r fig-9-5, echo=FALSE, fig.margin=FALSE, fig.cap='OECD Average standard VAT rates*. Source: ???'}
knitr::include_graphics('ChapterPictures/9-5-OECDVATRates.png', dpi = NA)
```
...
```{r fig-9-6, echo=FALSE, fig.margin=FALSE, fig.cap='Corporation Tax and Income Tax. Source: ???'}
knitr::include_graphics('ChapterPictures/9-6-CorporationTax-unitarytax.PNG', dpi = NA)
```
