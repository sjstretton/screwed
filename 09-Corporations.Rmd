...
We suggest methods for comabtting the scourge of tax evasion. 
...
Knowledge is Power. In this chapter we aim to empower the reader with information about what exactly the corporation tax landscape looks like in the UK and how it operates, and explain why the current framework permits certain issues to persist. 
...
In the next couple of sections we explore a couple of options
...
# 9.5 Transforming the Role of the Corporation ^^

What we have proposed up to this point may have seemed ambitious enough. We have tried to work out ways that corporations (especially large corporations) could pay more tax, and to replace the current 'race to the bottom' with a 'race to the top'. In this section our role is even more ambitious: to transform the role of the large corporation in our society.

So what is the current role, and the new role? Well we can compare corporations with individuals. Individuals have to make a living, but they also have social responsibilities to those around them - their families, friends, communities and other charitable causes. Whilst companies are also committed to these causes, often they do so just to look good. But we need large and focusseds organisations not only for the provision of *private* goods and services, but also *public* goods and services. Quite often, at the moment, these *public* goods are such because there is no private business model for providing them. This needs to change.

Let's give some examples. A new and effective antibiotic drug should only be used in the most serious examples. But that means that there is no business model for providing it, if the model for rewarding pharmaceutical companies is based on selling drugs. Finding a new antibiotic is very expensive.

Let's consider social media. At present, the business model of Facebook is to find a way to attract people's attention and use that attention to sell advertising. Instagram similarly captures the attention of young people interested in their own appearance. There are very real psychological downsides, which can be measured, from these tools. What if we measured how much social benefit or harm Facebook caused? It's not easy to do, but one proxy might be teenage suicide rates.

How about technology? Here we have a paradox. We need new technologies to tackle our serious problems. But once created, we need these technologies to be cheaply available to all. It's not good enough that technologies are patented and kept secret except for those willing to pay a sky-high-fee.

What about fossil fuel companies? At the moment they resist change. But how about if we create an incentive for these companies to tackle climate change? We provide 'payment by results'

In our proposals chapter we consider the possibility of taxing corporate *wealth*, and then providing rebates based on progress to achieve social goals. Such policies are not easy to design and we do not purport to have solved all the design issues here. But we must try. It would be better to provide a somewhat rough-and-ready estimate of each companies' social effect than the present situation where companies are actively incentivised to lobby against the public interest.
...
The first thing to say is that existing tax law, including on transfer pricing, should be enforced effectively. Nevertheles, since our goal here is quite broad-brush we will rather propose two radical suggestions for reform

## Proposal 1: The 'Dyson Tax'
...
##  Proposal 2: Decaying International Property Rights: A Wealth Tax on Companies ^^

Whilst a cashflow tax is helpful it does not deal with all the issues. Also, we want to tax not just *income* (with the cashflow tax as a backstop to the income tax), but also *wealth*. Companies have income, for sure, but they also represent wealth to the shareholders. Under our approach we believe the first step is to attempt to tax the underlying assets.

Imagine if a company is building up rents for the long term and invests all its free cashflow in building up a massive monopoly position? Companies can be in effect building up potential, but unrealised 'rents' the ability to make permanent surpluses that are not competed away. Some have described Amazon's behaviour as being similar to this. 

Finally, whilst the Dyson tax should at least be paid by the big corporates, it also seems to be a tax paid on marginal production, not a tax on rents of those with the dominany position.

Taxing total market asset value seems to be a way to tax wealth. By total market asset value we mean the total of a company's equity (as measured by the market) and outstanding debt (book value). This total market asset value would be allocated to the UK according to a form of apportionment formula. We suggest two factors: UK Sales, and UK value added, equally weighted. The difference with uk value added is that for a importing company that adds only a small margin.

Once this apprortionment formula is defined, we would deduct the value of UK tangible assets as measured for the purpose of land value tax or business rates. We intend not to disincentivise investment in the UK but the reverse. Rather we are interested in valuing the market's estimate of 'rent'.

Finally, there's another way for companies to rebate their tax, through social goals. Applying rebates to sectors based on sectoral ESG goals would be a valuable way to counteract lobbying interests, while achieving social goals. The outcome would put the onus on companies to act to achieve sectoral progression, rather than on regulation from the government. 

Our ideas here are similar to those of Shann Turnbull^[See for example https://papers.ssrn.com/sol3/papers.cfm?abstract_id=437981]. Turnbull suggests that large corporations should be 'decaying ownership'. If large corporations do not continually invest, then the ownership would gradually accrue to the community. Thus companies should have the option to pay this tax in shares, and those shares should be given to individuals in proportion to the tax they have paid.

Unlike our other proposals, this 'wealth tax on companies' is little more than a first draft. We suggest it as a way to propmote debate and as a contribution to tax design. To implement such a tax, we would convene a series of experts, but a single tax designer - like Beveridge - should have authority to make proposals to the government.
