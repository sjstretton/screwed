...
Even if we accept the scientists' warnings and resolve to act on them, our situation remains very tricky. You and I have little control over the direction of the world economy. There is no single captain of *Spaceship Earth*^[The first known use of this analogy is in *Progress and Poverty* [@George1879]. See also https://en.wikipedia.org/wiki/Spaceship_Earth]. Indeed, most of us have little idea how  exactly the controls of our economy work. 
...
We will therefore need everyone on board Spaceship Earth to act -- and to not stop acting. But what actions should we each take? What, precisely, is the role of individuals here? 
