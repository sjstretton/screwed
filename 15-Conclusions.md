...
Taxes, amongst their other roles of providing nudging incentives and redistributing income, are predominantly aimed at financing public provision of goods and services - including welfare for the most needy in society. We emphasise that these three balls need to be balanced carefully so as to ensure that the UK's Tax and Welfare system helps us build the society that we aim to achieve.

We summarise the findings from our discussion below. Broadly, on the whole, we propose to simplify the income tax and benefit system, and augment taxes where there is a social outcome that needs to be achieved through discouraging negative behaviour. A comprehensive Land Value Tax (LVT) should be phased in, so as to ensure that land is successfully developed, such that any excess rent can be captured and the windfall redistributed.
