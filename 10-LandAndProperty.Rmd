...
```{r fig-10-1, echo=FALSE, fig.margin=FALSE, fig.cap='Real Wages vs House Prices. Source: ???'}
knitr::include_graphics('ChapterPictures/10-1-RealWagesvsHousePrices.png', dpi = NA)
```
...
```{r fig-10-2, echo=FALSE, fig.margin=FALSE, fig.cap='First time buyer earnings to house price ratio across the UK. Source: ???'}
knitr::include_graphics('ChapterPictures/10-2-Firsttimebuyer.png', dpi = NA)
```
...
```{r fig-10-3, echo=FALSE, fig.margin=FALSE, fig.cap='House price affordability compared between Burnley and London. Source: ???'}
knitr::include_graphics('ChapterPictures/10-3-Housepriceaffordability.png', dpi = NA)
```
...
```{r fig-10-4, echo=FALSE, fig.margin=FALSE, fig.cap='Percentage of each age group that are home owners in England, 1981-2014. Source: Ough (2016)'}
knitr::include_graphics('ChapterPictures/10-4-Percentageownershipbyage.png', dpi = NA)
```
...
```{r fig-10-5, echo=FALSE, fig.margin=FALSE, fig.cap='Upper bounds of household net property wealth in 2012. Source: ???'}
knitr::include_graphics('ChapterPictures/10-5-Householdnetpropertywealth2012.png', dpi = NA)
```
...
If you're not convinced, conside Figure 46 below [@Wightman2013]. This graph compares four important costs relating to housing, and shows how they have changed over time. The lowest line on the graph, 'Build Costs,' is the cost of actually constructing a house. 'House Price' is the value of the house only, and 'Land Price' is the value of the underlying land only. 'Earnings' show the population's average earnings.
...
```{r fig-10-6, echo=FALSE, fig.margin=FALSE, fig.cap='Index of housing market costs 1983-2007. Source: ???'}
knitr::include_graphics('ChapterPictures/10-6-Indexofhousingmarketcosts1983-2007.png', dpi = NA)
```
...
```{r fig-10-7, echo=FALSE, fig.margin=FALSE, fig.cap='The Landlord\'s Game, precursor to \'Monopoly\', was invented by Elizabeth Magie*. Source: ???'}
knitr::include_graphics('ChapterPictures/10-7-Monopoly.jpg', dpi = NA)
```
...
```{r fig-10-8, echo=FALSE, fig.margin=FALSE, fig.cap='Everybody works but the vacant lot. Source: ???'}
knitr::include_graphics('ChapterPictures/10-8-GeorgeSign.jpg', dpi = NA)
```
...
```{r fig-10-9, echo=FALSE, fig.margin=FALSE, fig.cap='Land Value Taxation: Theory Evidence and Practice - Countries with Land Value Taxation by Year of Adoption. Source: Dye (2009)'}
knitr::include_graphics('ChapterPictures/10-9-DenmarkLVT.png', dpi = NA)
```
...
Another effect of the immobile or fixed location of land is that it suffers externalities - both positive and negative - from activities on surrounding land. That is, the economic value of a piece of land is affected directly by what is going on by the land surrounding it. So for example, land's economic value can be affected by negative externalities such as pollution or crime in the surrounding area. The value of land can also be increased by 'positive externalities,' such as improvements to local infrastructure and the creation of public amenities.
...
```{r fig-10-10, echo=FALSE, fig.margin=FALSE, fig.cap='Land, Rent, and Income Inequality. Source: ???'}
knitr::include_graphics('ChapterPictures/10-10-WealthRentIncreases1.png', dpi = NA)
```
...
# 10.14 Taxes on Land and Property
