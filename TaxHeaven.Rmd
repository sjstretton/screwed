...
#if(Platform=="PC") setwd("~/../Google Drive/Book") #else if(Platform=="Mac") setwd("~/Google Drive/Book") 
setwd("~/Github/TaxHeaven/taxheaven") #Add something for your WD if this doesn't work# 
...
```{r child = '1/01A-TurningTheShip.md'}
```

\newpage

```{r child = '1/01B-Scope.md'}
```

\newpage

```{r child = '1/01C-KeyMessage.md'}
```

\newpage

```{r child = '1/01D-TypesOfGood.md'}
```

\newpage

```{r child = '1/01E-EconomicThought.md'}
```

\newpage

```{r child = '1/01F-TaxTheoriesOfChange.md'}
```

\newpage

```{r child = '1/01G-EconomicModelWealth.md'}
```
