---
title: "Screwed? How Tax Heaven Can Fix Our Economy and Planet"
...
```{r child = '02-QuestionsOfThisBook.Rmd'}
```
...
```{r child = '03-RevolutionsInTheMindsOfMen.Rmd'}
```
