...
```{r child = '01-APerfectStorm.md'}
```

\newpage

```{r child = '02-Revolutions.md'}
```

\newpage

```{r child = '03-ProgressAndProblems.md'}
```

\newpage

```{r child = '04-DesertIslandEconomics.md'}
```
