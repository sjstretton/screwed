...
DiagrammeR("graph TB
    A[Define the Scope and the book and Problem]-->B[Define Economic System and Theory of its operation]
    B-->C[Define Economic and Justice Principles]
    C-->D[Consider Tax System in Principle & Practice]
    D-->E[Solve Issues in Each Sector of the Economy]
    E-->F[Sum up Proposals and How to Transition. Conclude]
")
```
...
```{r child = '00-Introduction.md'}
```


\newpage

```{r child = '01-EconomicModelWealth.md'}
```
...
```{r child = '04-CollectiveActionAndChange.md'}
```
