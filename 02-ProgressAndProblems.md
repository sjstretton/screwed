...
There is a case for higher taxes on wealth. We should tax unproductive and unearned wealth in a way that is unavoidable, including a land value tax. But such changes need to be just in transition. Allied to our tax on wealth is a tax on lending on existing assets (as opposed to new business investment). Thus, we aim to encourage investment across the economy. We use the financial system to actively promote the capture of land rent for public purposes. 
...
## Improvement 1: Power to the People (Chapter 7 and 8)
...
Taxing property values rather than property per se would stabilise the current property values. Where land valiue increases, this increase would ne allocated between the local community, the municipal authority and the central government. 
...
## IMPROVEMENT 3: A PROSPEROUS AND WEALTHY COUNTRY (CHAPTER 9 and 10)
...
It discourages foreign investment in a financial sense whilst encouraging investment in a real sense. An optimal taxation system would involve a collaboration between state and the private sector, so the gains of research and development investment are shared between both. 
