...
Taxation should correct the market, so that those who damage the environment pay for the damage that they cause. Such a tax system would tax bad things, not good things. The physical use of natural resources should be taxed, and the circular use of those resources is thereby encouraged. Hence, with a proper tax system, the beautiful things that require care, like the natural environment, would be preserved. The limited things such as land would be rationed by taxes, and the tax on incomes reduced. In this way everyday people woudl have a stake in the common resources and land and property would not become so expensive that individuals cannot afford their own homes.
