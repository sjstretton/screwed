...
Tax is the means by which we pay for government services. But this book isn't really about government. Rather it is about the use the taxation system to ensure that the *private sector* has the right incentives. 

There are two, distinct, systems that are in scope of our book. The first is the entire private sector. This book is about how the private sector can contribute to the well-being and the good of society. If the private sector does not have the right incentives, it will not produce the right outcomes. The second system is the tax system itself. Thirdly, we consider some aspects of the social security system as it overlaps heavily with the tax system.

The central concern of the book is the use of the tax system for public benefit. This book is devoted to how to pay for public services and social protection in a world characterised by 'wicked externalities', 'generalised rent', and international flows of money and assets. 
...
We wish to solve the critical challenges facing our societies including climate change, poverty and the complexity, avoidance and evasion in our taxation and welfare systems. .

Taxation should  correct the market, so those who damage the environment pay for the damage that they cause. Such a tax system would tax bad things, not good things. The physical use of natural resources should be taxed, and the circular use of those resources is thereby encouraged. So, with a proper tax system, the beautiful things that require care, like the natural environment, would be preserved. So the limited things would be rationed by taxes rather than by private property, so that everyday people have a stake in the common resources and land doesn't become so expensive that individuals cannot afford their own homes

Because this book is about taxation and welfare in the context of the real economy, and even the global environment, inevitably it overlaps with other systems. Crucial matters of overlapping concern include energy, housing and finance. Our focus is mostly on taxation in relation to the problems seen in these systems. Nevertheless, with this focus, we do not mean to exclude specific policy changes that are not related to taxation. Simply we want tax to help us solve our social and environmental problems, but it's not the only method for so doing.
...
## IMPROVEMENT 3: A PROSPEROUS AND WEALTHY COUNTRY (CHAPTER 09 and 10)
