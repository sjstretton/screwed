...
```{r fig-2-1, echo=FALSE, fig.margin=TRUE, fig.cap='Plaque marking the site in Kirkcaldy where Smith lived. Source: Wikipedia'}
knitr::include_graphics('ChapterPictures/AdamSmithSmall.png', dpi = NA)
```
...
4. What are the principles of effective tax and social security reform?
5. What improvements would effective reform bring?
