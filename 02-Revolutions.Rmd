...
```{r fig-1-2, echo=FALSE, fig.margin=TRUE, fig.cap='Evolution of the UK National Debt. Source: ???'}
knitr::include_graphics('ChapterPictures/HistoryOfDebt.png', dpi = NA)
```
