...
As we will explore in the coming chapters, in more detail, things are changing, but not significantly enough. Proposals put in place that aim to move towards a universal credit system have ignored the need for changes to be practical, beneficial and fair. HMRC’s tightening up of tax evasion has yet to fully solve the problem. And destructive behaviours, especially by corporations, have yet to fully be targeted through the use of taxation. There is still a significant way to go with realising our principles in practice. 
