...
This book is about the economic conditions for widely spread and sustainable prosperity. It tries to answer the question that why given great technological and economic progress, do we still have problems? Why amidst so much wealth do many people fail and their lives are economically precarious? If in the 1960s it took an average person on average wages four years wages to buy their own home, why now does it take an average person on average wages ten years of wages to buy the same home -- if, that is, they have anything left over to save up after paying their current landlord? If we have all the technology to solve our environmental problems -- climate change, plastic pollution and overfishing for example -- then why are we not solving these problems? If we can find the root cause, then we will perhaps be able to find a remedy.  

Henry George’s book Progress and Poverty also asked the question, Why in the context of technological progress did we still have so much poverty? This book asks a similar question. We have a market economy in most of the world with competition, growth and technological progress. But we still have economic precariousness and environmental pollution despite having the wealth and technological ability to prevent these things. In other words, we face a world where our economic system is not allowing us to take full advantage of the progress that we make. So why do we have these problems of pollution and precariousness? We identify three phenomena described by the great economists. 

The first notion we call economic theft. Economic theft (known by economists by the technical term externality) is when one person or company’s behaviour damages another person or the environment where the first person does not pay for it. So for example, if I throw my plastic waste into the ocean, it can then damage fish and other marine life. My careless action has stolen from the future of the ocean. 
The second notion we call spillover benefit. In this case, my actions create benefits for someone else or for the natural environment but I am not paid for it. 

The third notion we call economic rent. Economic rent is a permanent flow of income associated with an asset that cannot be replicated. It should be noted that economic rent comes from two main sources both of which are associated with a form of monopoly. The first source is a fundamental limitation of some valuable asset, for example, land. The second source is market power for organisations, for example, a large company able to keep prices high -- well above the cost of production. The result of economic rent is that the gains of economic progress accrue to the wealthy rather down to the population. Much of the population still lives in a state of economic precariousness.
